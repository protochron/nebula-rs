//! Real-nebula interop test (AES-256-GCM): proves nebula-protocol can
//! complete a handshake and exchange an IP packet with the actual Go
//! `nebula` v1.10.3 binary. Requires Docker.
//!
//! Run with: cargo test --test interop_aes -- --ignored --nocapture
...
#[tokio::test]
#[ignore]
async fn handshake_and_icmp_echo_with_real_nebula() {
